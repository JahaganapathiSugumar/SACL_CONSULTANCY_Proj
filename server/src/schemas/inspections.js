...
export const sandPropertiesSchema = z.object({
    ...
    vcm: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    loi: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    afs: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    gcs: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    moi: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    compactability: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    permeability: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    remarks: z.string().optional().nullable(),
    is_edit: z.boolean().default(true),
    is_draft: z.boolean().default(false)
});
...
export const dimensionalInspectionSchema = z.object({
    ...
    yields: z.preprocess((v) => (v === "" || v === null ? null : Number(v)), z.number().nonnegative().nullable().optional()),
    inspections: jsonValueSchema.optional().nullable(),
    remarks: z.string().optional().nullable(),
    is_draft: z.boolean().default(false),
    is_edit: z.boolean().default(true)
