...
router.post('/', verifyToken, validateTrial, authorizeDepartments(1, 8, 3), validate(machineShopSchema), asyncErrorHandler(machineShopController.createMachineShop));
router.put('/', verifyToken, validateTrial, authorizeDepartments(1, 8, 3), validate(updateMachineShopSchema), asyncErrorHandler(machineShopController.updateMachineShop));
