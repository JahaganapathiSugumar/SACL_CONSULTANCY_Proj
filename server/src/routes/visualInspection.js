...
router.post('/', verifyToken, validateTrial, authorizeDepartments(1, 5), validate(visualInspectionSchema), asyncErrorHandler(visualInspectionController.createInspection));
router.put('/', verifyToken, validateTrial, authorizeDepartments(1, 5), validate(updateVisualInspectionSchema), asyncErrorHandler(visualInspectionController.updateInspection));
