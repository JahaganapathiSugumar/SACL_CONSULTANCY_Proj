...
declare module '@mui/icons-material/*' {
  ...
  const Icon: React.ComponentType<React.SVGProps<SVGSVGElement> & { fontSize?: 'inherit' | 'small' | 'medium' | 'large' } & { [key: string]: any }>; // eslint-disable-line @typescript-eslint/no-explicit-any
  export default Icon;
}
