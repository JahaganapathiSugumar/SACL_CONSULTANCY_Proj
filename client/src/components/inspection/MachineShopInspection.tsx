                              ...
                              {r?.values?.map((val, ci) => (
                                <TableCell key={ci}>
                                  <TextField
                                    ...
                                    disabled={r.label === "Cavity Number" || r.label === "FDY OK Quantity" || ((user?.role === 'HOD' || user?.role === 'Admin' || user?.department_id === 2 || (user?.department_id === 3 && readOnly)) && !isEditing) || r?.label?.toLowerCase()?.includes("accepted quantity") || r?.label?.toLowerCase()?.includes("rejection percentage")}
                                  />
                                </TableCell>
                              ))}
